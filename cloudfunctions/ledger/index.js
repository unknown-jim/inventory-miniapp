  ...
  return {
    ...
    async runTransaction(fn) {
      ...
      try {
        ...
        // **时间被彻底排除**。**2026-08-25 的对照实验又把条数和体积分开了：
        // 是体积。** 同样 47 条单事务写入，新建空店（ledgers 5,932 字节）
        // 通过、3.6 秒；演示店（ledgers 3.6 MB）失败、11.3 秒。条数相同、
        // 唯一变量是账本大小。详见 ledger-records.js 的 SALE_RETURNS_MAX 那段。
